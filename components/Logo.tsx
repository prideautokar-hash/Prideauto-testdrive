...
export const Logo: React.FC<LogoProps> = ({ className, logoSrc, onUpload }) => {
    ...
    return (
        <div 
            className={`flex items-center justify-center overflow-hidden group relative ${className} ${isClickable ? 'cursor-pointer' : ''}`}
        ...
        >
            {logoSrc ? (
                ...
                <div className={`w-full h-full bg-white border-2 border-blue-200 rounded-md flex items-center justify-center p-2`} style={{ borderColor: '#98B6D7' }}>
